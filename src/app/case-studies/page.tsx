        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="space-y-12">
            {industries.map((industry, ii) => (
              ...
              >
                <h2 className="mb-5 text-xs font-bold uppercase tracking-widest text-coral-500">
                  {industry.name}
                </h2>
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
                  {industry.clients.map((client) => {
                    ...
                    const inner = (
                      <div
                        className={`group flex h-24 flex-col items-center justify-center rounded-xl border bg-white px-4 py-3 text-center transition-all duration-300 ${
                          hasCaseStudy
                      ...
                      >
                        {client.logo ? (
                          ...
                          <span className="text-sm font-bold text-dark-900/60 group-hover:text-dark-900 transition-colors">
                            {client.name}
                          </span>
                        )}
                        {hasCaseStudy && (
                          <span className="mt-1.5 text-[10px] font-semibold uppercase tracking-wider text-coral-500 opacity-0 group-hover:opacity-100 transition-opacity">
                            View Story
                          </span>
                        )}
                      </div>
      ...
      <section className="bg-gray-50 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          <h2 className="text-2xl font-extrabold text-dark-900 sm:text-3xl">
            ...
            <span className="text-coral-500">success story</span>?
          </h2>
        ...
        {activeCaseStudy && (
          ...
          >
            ...
            >
              ...
              {/* Badge */}
              <span className="inline-block rounded-full bg-coral-50 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-coral-500">
              ...
              <div className="mt-8 rounded-xl bg-gray-50 p-5">
                ...
                <p className="mt-3 text-xs font-semibold text-dark-900">
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                <Link
                  href="/contact?demo=true"
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-coral-500 px-6 py-2.5 text-xs font-bold uppercase tracking-wider text-white transition-all hover:bg-coral-600"
                  onClick={() => setActiveCaseStudy(null)}
                >
                  Request a Demo
                ...
                <button
                  onClick={() => setActiveCaseStudy(null)}
                  className="rounded-full border border-gray-300 px-6 py-2.5 text-xs font-bold uppercase tracking-wider text-gray-500 transition-all hover:border-gray-400 hover:text-dark-900"
                >
                  Close
                </button>
              </div>
